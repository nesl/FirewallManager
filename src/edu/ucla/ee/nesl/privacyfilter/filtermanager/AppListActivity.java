 ...
 * {@link AppListFragment} and the item details
 * (if present) is a {@link AppDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link AppListFragment.Callbacks} interface
...
public class AppListActivity extends FragmentActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.app_detail_container) != null) {
			...
			((AppListFragment) getSupportFragmentManager()
	...
	/**
	 * Callback method from {@link AppListFragment.Callbacks}
