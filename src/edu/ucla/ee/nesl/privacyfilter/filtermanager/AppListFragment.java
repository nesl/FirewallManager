...
public class AppListFragment extends ListFragment {
    ...
    public interface Callbacks {
         ...
         */
        public void onItemSelected(AppId app);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
				...
				ArrayList<AppFilterData> appFilterDataList = new ArrayList<AppFilterData>();
        ...
        setListAdapter(new AppViewAdapter(getActivity(), appFilterDataList));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected((AppId) view.getTag());
    }
